...
class mazePage:
    ...
    # Vẽ combo box chọn thuật toán
    def draw_cbbox(self):
        values = ["BFS", "DFS","IDL", "UCS", "Greedy", "A*", "Hill Climbing", 
                  "Simulated Annealing", "Beam Search", "And-Or Tree", "Belief state",
                  "Partially observable", "Backtracking", "Forward Checking", "AC-3"]
